...
const OrderSummary: React.FC = () => {
  ...
  const handleConfirm = () => {
    Alert.alert("Appointment Confirmed", "Your appointment has been successfully booked!", [
      { text: "OK" },
    ])
  }
...
const styles = StyleSheet.create({
  ...
  scrollWrapper: { flex: 1, marginHorizontal: 16 },
  ...
  timeContainer: { backgroundColor: "#f0f8ff", padding: 12, borderRadius: 8, borderLeftWidth: 4, borderLeftColor: "#007AFF" },
  dateTimeText: { fontSize: 16, fontWeight: "500", color: "#007AFF" },
  ...
  serviceInfo: { flex: 1 },
  serviceName: { fontSize: 16, fontWeight: "500", color: "#333", marginBottom: 2 },
  serviceDuration: { fontSize: 14, color: "#666" },
  servicePrice: { fontSize: 16, fontWeight: "600", color: "#007AFF" },
  ...
  totalPrice: { fontSize: 20, fontWeight: "bold", color: "#34C759" },

  noteText: { fontSize: 14, color: "#666", marginBottom: 4, lineHeight: 20 },

  bottomContainer: { backgroundColor: "white", padding: 16, borderTopWidth: 1, borderTopColor: "#e1e5e9" },
  confirmButton: {
    backgroundColor: "#34C759", paddingVertical: 16, borderRadius: 12,
    shadowColor: "#34C759", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3,
    shadowRadius: 8, elevation: 8,
  },
  confirmButtonText: { color: "white", fontWeight: "bold", fontSize: 18, textAlign: "center" },
})
